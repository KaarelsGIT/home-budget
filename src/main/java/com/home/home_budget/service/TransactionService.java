...
//    }
//
//    public BigDecimal getTotalTransactionAmount(Page<T> transactions) {
//        return transactions.stream()
//                .map(Transaction::getAmount)
//                .reduce(BigDecimal.ZERO, BigDecimal::add);
//    }
//
//    public BigDecimal getTotalFilteredTransactionAmount(Long userId, LocalDate date, Long categoryId, Integer year) {
